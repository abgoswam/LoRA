...
echo "creating nq_context3c_ansyes datasets..."
path=data/nq_context3c_ansyes
echo "train_tiny..."
python src/gpt2_encode.py --vocab vocab --input $path/train_tiny_formatted.jsonl --output $path/train_tiny.jsonl --add_bos --add_eos
echo "train..."
